...
import com.cenzer.Adapter.EditGroupAdapter;
import com.cenzer.Adapter.LightListAdapter;
...
import static com.cenzer.EncodeDecodeModule.TxMethodType.GROUP_STATE_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.LIGHT_LEVEL_GROUP_COMMAND_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.LIGHT_LEVEL_GROUP_RESPONSE;
...
public class EditGroupFragment extends Fragment implements ReceiverResultInterface, AdvertiseResultInterface {
    ...
    NonScrollListView editGroupDeviceList;

    @BindView(R.id.available_group_device_list)
    NonScrollListView availableGroupDevice;
...
//        byteQueue1.push(RxMethodType.LIGHT_LEVEL_GROUP);
//        byteQueue1.push(groupDetailsClass.getGroupId());
...
//        advertiseTask1.setSearchRequestCode(LIGHT_LEVEL_GROUP_RESPONSE);
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.group_status:
                ...
                advertiseTask.setSearchRequestCode(TxMethodType.GROUP_STATE_RESPONSE);
            ...
            case R.id.check_level:
                ...
                advertiseTask = new AdvertiseTask(this, activity);
                advertiseTask.setByteQueue(byteQueue);
                advertiseTask.setSearchRequestCode(TxMethodType.LIGHT_LEVEL_GROUP_RESPONSE);
                advertiseTask.startAdvertising();
                break;
            case R.id.set_level:
                showDialog();
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask = new AdvertiseTask(EditGroupFragment.this, activity);
                advertiseTask.setByteQueue(byteQueue);
