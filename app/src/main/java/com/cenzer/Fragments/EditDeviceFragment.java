...
import static com.cenzer.EncodeDecodeModule.TxMethodType.GROUP_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.LIGHT_LEVEL_COMMAND_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.LIGHT_LEVEL_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.LIGHT_STATE_COMMAND_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.LIGHT_STATE_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.SELECT_MASTER_RESPONSE;
import static com.cenzer.EncodeDecodeModule.TxMethodType.UPDATE_GROUP_RESPONSE;
...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask = new AdvertiseTask(EditDeviceFragment.this, activity);
                advertiseTask.setByteQueue(byteQueue);
    ...
    public void checkMaster() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                deviceClass1.setDeviceDimming(cursor.getInt(cursor.getColumnIndex(DatabaseConstant.COLUMN_DEVICE_PROGRESS)));
                deviceClass1.setGroupId(cursor.getInt(cursor.getColumnIndex(DatabaseConstant.COLUMN_GROUP_ID)));
                deviceClass1.setMasterStatus(cursor.getInt(cursor.getColumnIndex(DatabaseConstant.COLUMN_DEVICE_MASTER_STATUS)));
                deviceClass1.setStatus(cursor.getInt(cursor.getColumnIndex(DatabaseConstant.COLUMN_DEVICE_STATUS)) == 1);
