...
//                        arrayList.get(position).setStatus(true);
                ...
                advertiseTask=new AdvertiseTask(IndividualLightAdapter.this,IndividualLightAdapter.this,activity);
                advertiseTask.setByteQueue(byteQueue);
...
//            scannerTask.setRequestCode(TxMethodType.LIGHT_LEVEL_COMMAND_RESPONSE);
                advertiseTask=new AdvertiseTask( IndividualLightAdapter.this,activity);
                advertiseTask.setByteQueue(byteQueue);
